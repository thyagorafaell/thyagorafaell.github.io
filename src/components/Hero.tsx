      ...
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="space-y-6">
          ...
          <button 
            ...
            className="group inline-flex items-center gap-2 px-8 py-4 bg-slate-900 text-white rounded-full hover:bg-slate-800 transition-all duration-300 hover:scale-105"
          >
            Explore My Work
